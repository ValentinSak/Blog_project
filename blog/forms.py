...
class CommentForm(forms.ModelForm):
    ...
    body = forms.CharField(required=True, widget=SummernoteWidget(attrs={"class": "form-control", 'placeholder': 'Enter search term...',
...
class SearchForm(forms.Form):
    query = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control mb-1',
